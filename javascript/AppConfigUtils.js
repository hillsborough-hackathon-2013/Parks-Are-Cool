define(["dojo/_base/declare","dojo/_base/lang","dojo/Deferred" , "dojo/promise/all" , "esri/arcgis/utils"],
    function(declare,lang,Deferred, all, utils){
        var AppConfigUtils =  declare("",null,{
           ...
           // return this._queryOrganization().then(lang.hitch(this,this._queryApplication));
                 ...
                 all([this._queryPortal(), this._queryApplication()]).then(dojo.hitch(this, function(){
